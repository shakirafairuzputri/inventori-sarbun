                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                            <li><a class="dropdown-item" href="{{ route('admin.dashboardo') }}">Dashboard</a></li>
                ...
                <nav class="sb-sidenav accordion custom-sidebar" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="nav">
                            ...
                            <a class="nav-link {{ request()->routeIs('admin.dashboardo') ? 'active' : '' }}" href="{{ route('admin.dashboardo') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Dashboard
                            </a>                                                     
                            <div class="sb-sidenav-menu-heading">Kelola</div>
                            <a class="nav-link {{ request()->routeIs('admin.kelola-user') ? 'active' : '' }}" href="{{ route('admin.kelola-user') }}" aria-expanded="false">
                                <div class="sb-nav-link-icon"><i class="fas fa-person" style="margin-right: 8px;"></i></div>
                                Kelola User
                            </a> 
